...
public:
  Params(
    double foot_lift_amp, double period, double dt, double footh_forward_multiplier,
    double footh_left_multiplier)
  ...
  double foot_lift_amp_;
  double period_;
  double dt_;
  double footh_forward_multiplier_;
  double footh_left_multiplier_;
};
}  // namespace feet_trajectory
